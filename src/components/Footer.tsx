      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center text-sm">
                ...
                <a href="mailto:sandjonyves@gmail.com" className="hover:text-white transition-colors">
              ...
              <li className="flex items-center text-sm">
                ...
                <a href="tel:+237690743737" className="hover:text-white transition-colors">
                  +237 690 743 737
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a
                  href="https://web.facebook.com/sandjon.yves"
                  target="_blank"
          ...
          {/* GitHub */}
          <div>
            <h3 className="text-white text-lg font-semibold mb-4">GitHub</h3>
            <ul className="space-y-2">
              <li>
                <a
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm">
              © {new Date().getFullYear()} Yves Sandjon. Tous droits réservés.
            </p>
          </div>
        </div>
      </div>
